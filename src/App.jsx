...
mport styles from './App.module.css'
...
function SplashScreen({ onDone }) {
  ...
  useEffect(() => {
    const t1 = setTimeout(() => setFading(true), 6500)
    const t2 = setTimeout(() => onDone(), 7200)
    return () => { clearTimeout(t1); clearTimeout(t2) }
  }, [])
  return (
    <div className={styles.splash} style={{ opacity: fading ? 0 : 1, transition: 'opacity .7s ease' }}>
